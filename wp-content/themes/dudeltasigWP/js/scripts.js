...
function showIfNotMobile(el, prop)
{
    if(!isMobile)
    {
        //console.log(el == ".iframeContainerTwitter");
        //console.log(el == ".iframeContainerFacebook");

        if(el == ".iframeContainerFacebook")
        {
            $('.iframeContainerTwitter').css('display', 'none');
        }
        else if(el == ".iframeContainerTwitter")
        {

            $('.iframeContainerFacebook').css('display', 'none');
        }
